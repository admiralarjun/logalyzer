          ...
          <Table>
            ...
            <TableBody>
              {items.map((alert) => (
                ...
                <TableCell>
                  <ViewandEditAlert alert_id={alert.id} crpf_unit_id={alert.crpf_unit_id} crpf_device_id={alert.crpf_device_id} threat_signature_id={alert.threat_signature_id} log_line={alert.log_line} assignid={alert.assignee__id}/>
                </TableCell>
                </TableRow>
              ))}
            </TableBody>
